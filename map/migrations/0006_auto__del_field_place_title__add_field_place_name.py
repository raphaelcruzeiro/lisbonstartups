...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Place.title'
        db.delete_column(u'map_place', 'title')

        # Adding field 'Place.name'
        db.add_column(u'map_place', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Place.title'
        db.add_column(u'map_place', 'title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50),
                      keep_default=False)

        # Deleting field 'Place.name'
        db.delete_column(u'map_place', 'name')
